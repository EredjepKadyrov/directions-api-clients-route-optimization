...
NSString* kSWGVrpApiErrorDomain = @"SWGVrpApiErrorDomain";
NSInteger kSWGVrpApiMissingParamErrorCode = 234513;
...
-(NSNumber*) postVrpWithKey: (NSString*) key
    ...
    if (key == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGVrpApiErrorDomain code:kSWGVrpApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
