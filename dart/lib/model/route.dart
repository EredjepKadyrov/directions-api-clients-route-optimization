...
/* array of activities */
  ...
  @override
  String toString()  {
    return 'Route[vehicleId=$vehicleId, distance=$distance, transportTime=$transportTime, completionTime=$completionTime, waitingTime=$waitingTime, activities=$activities, ]';
  }
