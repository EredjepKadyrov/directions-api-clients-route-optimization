...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (https://graphhopper.com/api/1/vrp).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://graphhopper.com/api/1/vrp");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://graphhopper.com/api/1/vrp).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://graphhopper.com/api/1/vrp")
        {
